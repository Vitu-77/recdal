...
var Overlay = styled__default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n\tposition: absolute;\n\tleft: 0vw;\n\twidth: 100%;\n\theight: 100vh;\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: center;\n\tz-index: 2;\n\topacity: 0;\n\ttransition: ", "ms;\n\ttop: ", "px;\n\tbackground: ", ";\n\n\t", ";\n"], ["\n\tposition: absolute;\n\tleft: 0vw;\n\twidth: 100%;\n\theight: 100vh;\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: center;\n\tz-index: 2;\n\topacity: 0;\n\ttransition: ", "ms;\n\ttop: ", "px;\n\tbackground: ", ";\n\n\t",
    ";\n"])), function (_a) {
    ...
    var show = _a.show;
    return show && styled.css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\t\t\topacity: 1;\n\t\t"], ["\n\t\t\topacity: 1;\n\t\t"])));
});
var Modal = styled__default.div(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n\ttransition-timing-function: ", ";\n\tmargin: 0;\n\tpadding: 0;\n\twidth: max-content;\n\theight: max-content;\n\tz-index: 3;\n\ttransition-duration: ", "ms;\n\ttransition-delay: ", "ms;\n\tbackground: transparent;\n\n\t", ";\n"], ["\n\ttransition-timing-function: ", ";\n\tmargin: 0;\n\tpadding: 0;\n\twidth: max-content;\n\theight: max-content;\n\tz-index: 3;\n\ttransition-duration: ", "ms;\n\ttransition-delay: ", "ms;\n\tbackground: transparent;\n\n\t",
    ";\n"])), function (_a) {
    ...
    switch (transition === null || transition === void 0 ? void 0 : transition.type) {
        ...
        case 'slide':
            switch (transition === null || transition === void 0 ? void 0 : transition.direction) {
                ...
                case 'right-left':
                    return styled.css(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n\t\t\t\t\t\t\ttransform: translate(calc(100vw + 200%), 0);\n\t\t\t\t\t\t"], ["\n\t\t\t\t\t\t\ttransform: translate(calc(100vw + 200%), 0);\n\t\t\t\t\t\t"])));
                case 'left-right':
...
var Recdal = function (_a, ref) {
    ...
    var _f = React.useState(initialData), modalData = _f[0], setModalData = _f[1];
    var _g = React.useState(false), lockModal = _g[0], setLockModal = _g[1];
    var _h = React.useState(defaultVisible), showModal = _h[0], setShowModal = _h[1];
    var _j = React.useState(defaultVisible), isMounted = _j[0], setIsMounted = _j[1];
    var _k = React.useState(0), modalPosition = _k[0], setModalPosition = _k[1];
    var getData = React.useCallback(function (key) {
        if (key) {
    ...
    var lock = React.useCallback(function () { return setLockModal(true); }, []);
    var unlock = React.useCallback(function () { return setLockModal(false); }, []);
    ...
    return (React__default.createElement(Overlay, __assign({}, rest.overlay, { show: isMounted, top: modalPosition, transitionDuration: (((_b = rest === null || rest === void 0 ? void 0 : rest.transition) === null || _b === void 0 ? void 0 : _b.duration) || 300) + 200 }),
        React__default.createElement(OutsideClickHandler, { onOutsideClick: function () {
                if (showModal && !lockModal && closeOnOverlayClick) {
                    close();
                }
            } },
            React__default.createElement(Modal, __assign({}, rest.modal, { transition: rest === null || rest === void 0 ? void 0 : rest.transition, show: isMounted }), rest.children))));
};
var Recdal$1 = React.forwardRef(Recdal);

exports.default = Recdal$1;
